...
$app->patch('/patch', function () {
 ...
 //-----------DELETE----------- //  
$app->delete(  $GLOBALS['pathapi']. '/delete' , 
    function () {
        echo 'This is a DELETE route';
    } 
); //-----------PUT----------- //
$app->put( $GLOBALS['pathapi']. '/put' , 
    function () {
...
$app->post( $GLOBALS['pathapi']. '/ActivityType' , function () use ($app) {  addActivityType( $app );
});
...
// //GET ALL Activity  
// $app->get( $GLOBALS['pathapi']. '/activity' , function () use ($app) {  
// 		  $data =queryDB(  'SELECT Id  ,
// 				Name  ,
// 				Description ,
// 				isPrivate ,
// 				joinersLimit  ,FromPeriod,ToPeriod
// 				ActivityType ,  
// 				Address  ,
// 				LatLoc ,
// 				LngLoc  FROM Activity;' ); 
...
// //GET ALL Joining  
// $app->get( $GLOBALS['pathapi']. '/joining' , function () use ($app) {
// 	// include out mysql connection code and make the connection
// 	require_once 'lib/mysql.php';
...
// //GET ALL Speaker  
// $app->get( $GLOBALS['pathapi']. '/speaker' , function () use ($app) {
// 	// include out mysql connection code and make the connection
// 	require_once 'lib/mysql.php';
...
// //GET ALL Speaking  
// $app->get( $GLOBALS['pathapi']. '/speaking' , function () use ($app) {
// 	// include out mysql connection code and make the connection
// 	require_once 'lib/mysql.php';
